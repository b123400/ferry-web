...
instance Cache CentralSokKwuWan where
    cacheFilename _ = "CentralSokKwuWan"

instance Scrap CentralSokKwuWan where
    route _ cursor = Route CentralSokKwuWan $ timetables cursor
